...
var bok = require('@eo4geo/bok-dataviz');
window.bok = bok;

},{"@eo4geo/bok-dataviz":2}],2:[function(require,module,exports){
var d3 = require("d3");
...
exports.parseBOKData = function (bokJSON) {
  ...
  for (var z = 0; z < bokJSON.contributors.length; z++) {
    for (var s = 0; s < bokJSON.contributors[z].concepts.length; s++) {
      var node = bokJSON.contributors[z].concepts[s];
      var contributor = {};
      contributor.description = bokJSON.contributors[z].description;
      contributor.nameShort = bokJSON.contributors[z].name;
      contributor.url = bokJSON.contributors[z].url;
      allNodes[node].contributors.push(contributor);
    }
  }
...
exports.visualizeBOKData = function (svgId, textId) {
  ...
  d3.json("https://raw.githubusercontent.com/ACFaul/BoK/main/AI4EO.json").then((root, error) => {
...
alert(error)
  ...
  exports.displayConcept = function (d) {
    ...
    if (textId != null) {
      ...
      pNode.innerHTML = "Permalink: <a href= 'https://www.bas.ac.uk/project/ai4eoaccelerator/bok/" + d.nameShort + "'> https://www.bas.ac.uk/project/ai4eoaccelerator/bok/" + d.nameShort + "</a>";
  ...
  displayUnorderedList = function (array, propertyname, headline, domElement, idNode) {
    if (array != null && array.length != 0) {
      ...
      for (var i = 0, j = array.length; i < j; i++) {
        ...
        var value;
	var description;
        if (propertyname != null) { //For Subconcepts, Demonstrable Skills, Source Documents and Contributors
          value = array[i][propertyname];
          nameShort = array[i]['nameShort'];
	  description = array[i]['description'];
        ...
        if (headline == "Subconcepts") {
          ...
          text += "<a style='color: #007bff; font-weight: 400; cursor: pointer;' href='" + value + "'>" + nameShort + "</a>: " + description + "<br>";
        } else {
          text += "<a>" + value + "</a> <br>";
        }
      };
...
},{"d3":34}],3:[function(require,module,exports){
